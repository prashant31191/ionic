...
.factory('$ionicPopup', ['$rootScope', '$q', '$document', '$compile', '$timeout', '$ionicTemplateLoader',
  ...
  return {
     ...
     * @param {data} object The options for showing a popup, which are
     *  - `{string=}` `content` The content of the popup as a string
     *    Default: ''
     *  - `{string=}` `title` The title of the popup as a string
     *    Default: ''
     *  - `{string=}` `subTitle` The sub-title of the popup as a string
     *    Default: ''
     *  - `{string=}` `templateUrl` The URL of a template to load as the content of the popup
     *    Default: ''
     *  - `{object=}` `scope` The scope to run the content under
     *    Default: creates a child of $rootScope.
     *  - `{array=}` `buttons` The buttons to show, of the form:
              buttons: [
                {
                  text: 'Cancel',
                  type: 'button-default',
